<div>
    <div class="container mt-5">
        <div class="mb-5">
            <a href="/admin/history/{{ $user->id }}/{{ $user->police_id }}" wire:navigate class="btn text-dark btn-default mt-3 btn-sm bg-dark-subtle"><i class="far fa-arrow-left"></i> Back</a>
        </div>
